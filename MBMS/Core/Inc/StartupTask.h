...
#define MOTOR_FLAG 0x02U // 00 0010
#define ARRAY_FLAG 0x04U // 00 0100
#define LV_FLAG 0x08U // 1000
#define CHARGE_FLAG 0x10U // 1 0000
#define ALL_CONTACTORS_FLAG ( COMMON_FLAG | MOTOR_FLAG | ARRAY_FLAG | LV_FLAG | CHARGE_FLAG)
