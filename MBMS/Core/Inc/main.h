...
#define Contactor_LEDs_Precharger_Pin GPIO_PIN_1
#define Contactor_LEDs_Precharger_GPIO_Port GPIOD
#define Array_Contactor_Precharger_Pin GPIO_PIN_2
#define Array_Contactor_Precharger_GPIO_Port GPIOD
#define Charge_Contactor_Precharger_Pin GPIO_PIN_3
#define Charge_Contactor_Precharger_GPIO_Port GPIOD
#define Motor_Contactor_Precharger_Pin GPIO_PIN_4
#define Motor_Contactor_Precharger_GPIO_Port GPIOD
#define LV_Contactor_Precharger_Pin GPIO_PIN_5
#define LV_Contactor_Precharger_GPIO_Port GPIOD
#define Common_Contactor_Precharger_Pin GPIO_PIN_6
#define Common_Contactor_Precharger_GPIO_Port GPIOD
